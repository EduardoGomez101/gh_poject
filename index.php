  ...
  switch ($Accion){
    ...
    case "subir":
      ...
      if ($Variable == "temperatura"){
        ...
        $mensajeComando = "FFFF00160000000000000000FFFFFF9300000000074242494E434F00FFA3000200000000000000000065FF83000E000000000000000000650000000000003F0".dechex($number."0")."000000FF83000E000000000000000000650000000000003F0".dechex($number."0")."000000FF83000E000000000000000000650000000000003F0".dechex($number."0")."000000";
      }
    break;
    case "bajar":
      if ($Objeto == "cortinas" || $Objeto == "persianas"){
